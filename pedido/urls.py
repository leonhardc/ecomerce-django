"""
    App pedido.
        ...
        Neste app se concentra em características básicas de um pedido em um
    processo de compra, como por exemplo, pagar o pedido, salvar o pedido para
    pagar depois e claro, detalhar o pedido, para o cliente poder revisar e ter
    a certeza que os produtos no carrinho são mesmo o que ele quer.
